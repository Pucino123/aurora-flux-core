  ...
  return createPortal(
    <AnimatePresence>
      ...
      >
        ...
        >
          {/* Header */}
          <div className={`flex items-center gap-3 px-5 pt-4 pb-2 border-b ${lightMode ? "border-gray-200/60" : "border-border/30"}`} style={lightMode ? { background: "#ffffff" } : undefined}>
